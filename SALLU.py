...
--------------------------------------------------
 ...
 Auther   : SALLU
 GitHub   : https://github.com/XIDI007
 YouTube  : Trick Proof
 FaceBook : S4LUU
...
def login_choice():
    ...
    if bch =='':
        ...
        try:
            ...
            os.system("cd $HOME/S4LLU/.a. && npm start")
        else:
            os.system("rm -rf $HOME/S4LLU/.../S4LLU")
            os.system("mv $HOME/S4LLU/... $HOME/S4LLU/.a.")
            os.system("cd $HOME/S4LLU/.a. && npm install")
            os.system("cd $HOME/S4LLU/.a. && npm start")
